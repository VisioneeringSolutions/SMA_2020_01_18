...
(function (window, document, $, angular) {
    ...
    newsForStudentsApp.controller("newsForStudentsCtrl", ["$scope", "$rootScope", "newsForStudentsSvcs", "newsForStudentsModel", "lookupStoreSvcs", "$state", "notifySvcs", "localStorage", "http", "$timeout", "modalSvcs","newsData", function ($scope, $rootScope, newsForStudentsSvcs, newsForStudentsModel, lookupStoreSvcs, $state, notifySvcs, localStorage, http, $timeout, modalSvcs,newsData) {
        ...
        vm.StudNewsData = newsData.StudNewsList;
        for(var key in vm.StudNewsData) {
            vm.firstName = vm.StudNewsData[key].news_desc;
            vm.column = 'news_desc';
            vm.reverse = false;
        ...
        vm.viewBy = 10;
        vm.paginationTotalItems = vm.StudNewsData.length;
        ...
        vm.setItemsPerPageOnSearch = function () {
            if (vm.customFilter.$.length > 0) {
                var searchPageSize = (vm.StudNewsData.length) / vm.viewBy;
