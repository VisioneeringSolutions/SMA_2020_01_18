...
(function (window, document, $, angular) {
    ...
    angular.module('dashBoardStudentApp').factory("dashBoardStudentSvcs", ["http", "$rootScope", function (http, $rootScope) {
        ...
        };var getTimeSlotDetailsForMobileStd = function (model, successCallback, errorCallback) {
            http.getAjaxTimeSlotTimeSlotDetailsForMobileStd(model, successCallback, errorCallback);
        };
        ...
        return {
            ...
            getTimeSlotDetailsForMobileStd : getTimeSlotDetailsForMobileStd
        }
