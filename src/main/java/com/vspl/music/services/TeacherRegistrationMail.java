...
public class TeacherRegistrationMail {
	...
	public static void composeMail(String firstName ,String email) {
		...
		sendteacherRegistrationMail(mailMap, recipientEmailList);

	}

	public static void sendteacherRegistrationMail(HashMap<String, Object> map, List<String> recipientEmailList) {
