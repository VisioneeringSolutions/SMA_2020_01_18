(function (window, document, $, angular) {
  ...
  angular.module('ui.bootstrap.contextMenu', []).service('CustomService', function () {'use strict';
  ...
  commonApp.directive('contextMenu', ['$rootScope', 'ContextMenuEvents', '$parse', '$q', 'CustomService', '$sce', '$document', '$window', '$compile',
